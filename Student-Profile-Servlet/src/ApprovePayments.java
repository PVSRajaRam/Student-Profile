...
/**
 * Servlet implementation class ApprovePayments
 */
@WebServlet("/ApprovePayments")
public class ApprovePayments extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        dispatcher = request.getRequestDispatcher("./jsp/ApprovePayments.jsp");
