...
/**
 * Servlet implementation class UpdateScholarship
 */
@WebServlet("/UpdateScholarship")
public class UpdateScholarship extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int slab=Integer.parseInt((String)request.getParameter("slab"));
		recordDAO.updateSlab(slab,rollno);
		recordDAO.updateFees(slab,rollno);
